<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PrintList.aspx.cs" Inherits="ArmLicence.PrintList" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <main id="main" class="main"><div class="pagetitle"></div><section class="section"><div class="row"><div class="col-lg-12"><div class="card">
            <div class="card-title text-center text-danger h2">List of Printed Card</div>
              <hr />
            <div class="card-body">
          ...
          <center>
            <form runat="server">
                ...
                <asp:GridView ID="GridView1" runat="server" CssClass="table table-hover" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" EmptyDataText="No Record Found" DataKeyNames="UIN">
                    <Columns>
                        <asp:CommandField SelectText="Print" ShowSelectButton="True" Visible="false"></asp:CommandField>
                    </Columns>
                </asp:GridView>
            </form>
